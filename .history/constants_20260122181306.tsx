...
export const TRANSLATIONS = {
  ar: {
    ...
    landing: {
      ...
      hero1: 'اصـنـع الـفـريـق',
      hero2: 'الأساطير',
      desc: 'نظام متقدم لتوليد الفرق بتوازن مدعوم بالذكاء الاصطناعي، مؤثرات بصرية مستقبلية، وحركات أسطورية.',
      btn_forge: 'تـولـيد التشكيلة',
      btn_manage: 'إدارة النخبة',
      f1_title: 'الذكاء الخارق',
      f1_desc: 'خوارزميات برمجية توازن الفرق بناءً على مستوى المهارة الخفي والأدوار.',
    ...
    generate: {
      ...
      modes: { random: 'عشوائي', balanced: 'متوازن', leader: 'قادة', ai: 'ذكي (AI)' },
  ...
  en: {
    ...
    landing: {
      ...
      hero1: 'FORGE THE',
      hero2: 'LEGENDARY',
      desc: 'Advanced team generation with AI-driven balancing, futuristic visuals, and legendary animations.',
      btn_forge: 'INITIALIZE FORGE',
      btn_manage: 'MANAGE SQUAD',
      f1_title: 'AI SMART',
      f1_desc: 'Proprietary algorithms that balance squads based on skill and roles.',
      f2_title: 'PRECISION',
    ...
    generate: {
      ...
      modes: { random: 'Random', balanced: 'Balanced', leader: 'Leaders', ai: 'AI Smart' },
